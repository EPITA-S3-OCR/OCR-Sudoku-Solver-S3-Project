 ...
 * @param trainButton Button to train the OCR Neural Network on a predefined dataset 
 * @param entryEpoch The Entry where the user can write the number of epochs to train on.
 */
typedef struct NN
{
 ...
 * @param launchProcessSolverButton Button to launch the process of solving the sudoku txt file
 */
 ...
 * @param stack The assembly of the different groups (OCR, Neural Network, Solver)
